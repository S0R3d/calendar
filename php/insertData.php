...
$query_insert_real = "INSERT INTO `event`(`id`,`title`,`sDate`,`fDate`,`sTime`,`fTime`,`real_evt_id`,`real_sDate`)
            VALUES ( :next_id_r , :title_r, :sdate_r, :fdate_r, :stime_r, :ftime_r, :r_evt_id_r, :r_sdate_r);";
...
for ($i = 1, $one = $sD; $fD->diff($one)->d > 0; ++$i) {
    ...
    $query_inser_end = "INSERT INTO `event`(`id`,`title`,`sDate`,`fDate`,`sTime`,`fTime`,`real_evt_id`,`real_sDate`)
                VALUES ( :next_id_e, :title_e, :sdate_e, :fdate_e, :stime_e, :ftime_e, :r_evt_id_e, :r_sdate_e);";
